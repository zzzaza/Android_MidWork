...
public class NotesList extends ListActivity {
    ...
    private int[] viewIDs = { android.R.id.text1};
    ...
    private static final String[] PROJECTION = new String[] {
            ...
            NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE,  //新增修改时间显示
    };
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.menu_paste:
          ...
          case R.id.menu_search: //搜索笔记
            ...
            case R.id.bg_change:  //选择主题
                showpopSelectBgWindows();
                return true;

            case R.id.menu_settings:  //设置
                Intent intent1 = new Intent(this, NoteSettings.class);
